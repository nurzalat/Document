...
<div id="columns">
    ...
    <div id="center">
        <fieldset>
            <legend><h1 align="left">Принятые документы</h1></legend>
            ...
            while(sizeof($results_array)>$i){
                ...
                echo '<fieldset><legend><h2 align="left">'.$results_array[$i]['subject'].'</h2></legend>'
                    ...
                    .'<ul class="rega">'
                    .'<li><label>От кого:</label></li><li class="in"><input type="text" name="fromuser" disabled="true" value="'.$results_array[$i]['fromuser'].'"><br /></li></ul><ul class="rega">'
                    ...
                    .'<li class="in"><button type="delete" value="delete" width="60px" height="20px">Delete</button></li></ul>'
                    .'</fieldset>';
                $i++;
            }
            ?>
